<!-- omit in toc -->
# Progetto d'esame per l'a.a. 2025/2026
...
d'esame per l'a.a. 2025/2026 e le modalità per la preparazione e la consegna.
...
derogabile) di quattro persone, anche di canali diversi; data la sua semplicità,
il progetto "Simulazione dell'interazione tra due specie" può essere svolto in
un gruppo di al massimo due persone. Il progetto può però essere preparato anche
singolarmente.

Il programma deve essere scritto in C++ standard, utilizzando esclusivamente
i costrutti e le indicazioni fornite a lezione nel corso dell'anno. Ogni
deviazione deve essere dichiarata nella relazione e adeguatamente giustificata.
...
installabili con il comando `apt install` oppure essere direttamente integrate
nel build del progetto con CMake. Non sono ammesse altre forme di installazione
di software esterno. Specificatamente all'uso della libreria SFML su macOS, si seguano
...
parametri da terminale via `std::cin` o da file di configurazione) o passati sulla linea di
...
messaggio d'errore e uscire dal programma. È preferibile evitare di ri-chiedere
all'utente un altro valore.
...
- dichiarazione e giustificazione dell'eventuale uso di costrutti non introdotti
  a lezione
...
- L'**originalità della soluzione** intende valutare innanzitutto il rispetto di
  ...
  dall'utilizzo corretto di strumenti, librerie, tecniche aggiuntivi.
...
all'orale ad appelli diversi. In tal caso, al fine di migliorare la valutazione,
è necessario che le variazioni apportate al progetto *vadano oltre a quelle proposte dai docenti*
